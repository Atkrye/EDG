...
bool neutral_b0 = true;
bool neutral_b1 = true;

static bool evaluateCondition(void)
{
   return (neutral_b0 && neutral_b1);
}
...
static void evaluatePredicate0(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) neutral_b0 = true;
   else neutral_b0 = false;
}
...
static void evaluatePredicate1(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) neutral_b1 = true;
   else neutral_b1 = false;
}
...
static bool fillpot_n5(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "Main_demorgansF1", host);
